                ...
                <div class="container">
                    <form>
                        <div class="form-row">
                            <div class="col-4"></div>
                            <div class="col-4">
                                <button type="button" class="btn btn-danger btn-lg btn-block">Listado de Decanatos.</button>
                            </div>
                        </div>
                    <br>
                    <div class="form-row">
                    ...
                    <div class="form-row">
                        <div class="col-4"></div>
                            <div class="col-1">
                                <label class="col-form-label">Decano:</label>
                            </div>
                            <div class="col-3">
                                <input type="text" class="form-control" placeholder="Decano">
                            </div>
                    </div>
                    <br>
                    <div class="form-row">
